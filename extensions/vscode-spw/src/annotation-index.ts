...
import type { SpwAnnotationKind, SpwCustomRequestClient } from './lsp/custom-requests'

// ---------------------------------------------------------------------------
// Types
// ---------------------------------------------------------------------------

export type AnnotationKind = SpwAnnotationKind
...
export class AnnotationIndex {
    ...
    constructor(private readonly requests: SpwCustomRequestClient) {}
    ...
    async rebuild(): Promise<void> {
        try {
            const rawEntries = await this.requests.annotations()
