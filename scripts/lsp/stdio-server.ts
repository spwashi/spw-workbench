...
// ── Helpers (extracted) ─────────────────────────────────────────
import {
  pathFromUri, uriFromPath, fileExists, statKind,
  parseWorkspaceRoot as _parseWorkspaceRoot,
  loadConfig as _loadConfig, mergeConfig,
  defaultRoots as _defaultRoots, parseRoots, mergeRoots as _mergeRoots,
  resolveCandidate, resolveReferencePath as _resolveReferencePath,
  collectWorkspaceSpwFiles, getWorkspaceSpwFiles as _getWorkspaceSpwFiles,
  mapWithConcurrency, stripAnchor, normalizeRelPath,
  levenshteinDistance, scoreCandidateName,
